...
COPY TinteX.DyeText.Platform/*.csproj TinteX.DyeText.Platform/
# Restore dependencies
RUN dotnet restore ./TinteX.DyeText.Platform
# Copy the rest of the application files
COPY . .

# Step 2: Deploy the application to builder stage
# Publish the application in Release mode
RUN dotnet publish ./TinteX.DyeText.Platform -c Release -o out
...
ENTRYPOINT ["dotnet", "TinteX.DyeText.Platform.dll"]
